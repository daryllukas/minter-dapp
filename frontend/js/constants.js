const contractAddress = "0x6130a96C9C308dd12A6F28c388a65EC267353A41"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the CeedVerse NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Introducing AOA Age of Annihilation, the story of a near-future, global apocalypse where #Afrofuturist innovation & #cannabis combine to save the world as we know it.<br />Can the elite Nacirfaz warriors from this planet harness the physical & metaphysical power of cannabis to unlock the plant\'s extraordinary capabilities and offer hope for the humanity of planet Ion?⁠<br/>⁠Learn more and join the mission! <br/> <br/> <a href="https://mailchi.mp/34046e6da82c/join-ceed"  target="_blank" rel="noopener noreferrer">Enter the CEEDVERSE!</a>.';
